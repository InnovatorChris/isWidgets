...
var date1_Var : Date  // 4D was throwing an error in the component because this var is not initialized until later (in the Form ON LOAD)
Case of 
	: (Form event code:C388=On Load:K2:1)
		IS_DATEENTRY_INIT(""; "procDate2")  // operate on process var (dataSource); NEXT OBJECT name is procDate1
